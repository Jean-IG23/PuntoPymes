"""
Django settings for PuntoPymes project.
...
# FIX: Configurar PYTHONIOENCODING para Windows (solo variable de entorno, no sys.stdout)
...
MIDDLEWARE = [
    ...
    'PuntoPymes.middleware.EncodingFixMiddleware',             # FIX: Encoding para Windows
...
WSGI_APPLICATION = 'PuntoPymes.wsgi.application'
...
# ======================================================
# LOGGING CONFIGURATION (Error Handling & Auditing)
# ======================================================
import logging
...
LOGGING = {
    ...
    'handlers': {
        'console': {
            ...
            'formatter': 'simple',
            'filters': ['require_debug_true'],  # Solo en desarrollo
        },
        'file': {
            'level': 'ERROR',
